...
class ExtendsFinancieraPrestamoCuota(models.Model):
	...
	def _mobbex_debit_execute(self):
		...
		primer_fecha = fecha_actual + relativedelta.relativedelta(days=self.mobbex_id.days_execute_on_expiration)
		segunda_fecha = fecha_actual + relativedelta.relativedelta(days=self.mobbex_id.days_execute_on_expiration+1)
		tercer_fecha = fecha_actual + relativedelta.relativedelta(days=self.mobbex_id.days_execute_on_expiration+2)
		cuarta_fecha = fecha_actual + relativedelta.relativedelta(days=self.mobbex_id.days_execute_on_expiration+self.mobbex_id.days_execute_after)
		fechas_ejecucion = [primer_fecha, segunda_fecha, tercer_fecha, cuarta_fecha]
